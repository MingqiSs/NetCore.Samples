...
namespace Infrastructure.Utilities
{
    public class HexStringUtil
    {
        ...
        public static string ByteArrayTo16String(byte[] data)
        {
            ...
            foreach (byte b in data) sb.Append(Convert.ToString(b, 16).PadLeft(2, '0'));
            return sb.ToString();
        }
        ...
        {
          //  return ByteArrayToHexStringEscape(data);
        ...
        /// <param name="data"> The array of bytes to be translated into a string of hex digits. </param>
        /// <returns> Returns a well formatted string of hex digits with spacing. </returns>
        public static string ByteArrayToHexStringEscape(byte[] data)
        {
            StringBuilder sb = new StringBuilder(data.Length * 3);
            foreach (byte b in data)
            {
                sb.Append("0x" + Convert.ToString(b, 16).PadLeft(2, '0').PadRight(3, ','));
            }
